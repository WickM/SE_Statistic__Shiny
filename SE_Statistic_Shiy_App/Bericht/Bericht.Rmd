...
## Relative Mobility Trends from Apple and Goolge Maps

```{r Report_plots, echo=FALSE, message=FALSE, warning=FALSE}
...
plots <- purrr::map(unique(data$percent_change_type), ~ plot_f(type = .x, data = params$data) ) 
plots
```
